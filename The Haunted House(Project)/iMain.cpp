...
void iMouse(int button, int state, int mx, int my)
{
		...
		if (l == 3 && o > 2)
		{
			...
			if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
			{
				...
				if (p == 1 && q == 1 && r == 1 && t == 1 && u == 1 && v == 1)
				{
					...
					{
						musicOn2 = false;
						PlaySound("Sound\\Scare.wav", NULL, SND_ASYNC);  //music the time scare appears
					}
				}
			}
		}
		if (l == 4 && w > 16)
		{
			if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
			{
				if (mx >= 625 && mx <= 865 && my >= 110 && my <= 615)
				{
					...
					{
						musicOn = true;
						PlaySound("Sound\\Playmusic.wav", NULL, SND_LOOP | SND_ASYNC);  //credits
					}
				}
			}
		}
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
	{
		if (image == 1 && l != 3 && l != 4 && l != 5)
		{
			...
			if (musicOn1)
			{
				musicOn = false;
				musicOn1 = false;
				PlaySound("Sound\\Insects.wav", NULL, SND_LOOP | SND_ASYNC);  
			}
		}
	}
	if (image == 1 && l == 5)
	{
...

		{
			...
			{
				musicOn = true;
				PlaySound("Sound\\Playmusic.wav", NULL, SND_LOOP | SND_ASYNC);  
			}
		}
	}
	...
	if (flag == 2 && l != 4 && l != 5 && MS == 0)
	{
		...
		if (notebath1 == 1)
		{
			if (key == 'b')
			{
				...
				if (notesound1 == 1)
				{
					...
					{
						musicOn1 = true;
						PlaySound("Sound\\Scare3.wav", NULL, SND_ASYNC);  //a creepy sound as the scenario of the room changes
					}
				}
		...
		if (notebath2 == 1)
		{
			if (key == 'b')
			{
				...
				if (notesound2 == 1)
				{
					...
					{
						musicOn1 = true;
						PlaySound("Sound\\Scare2.wav", NULL, SND_ASYNC);  //a creepy sound as the scenario of the room changes
					}
				}
		...
		if (notebed1 == 2 && notebed2 == 2 && chabi == 1)
		{
			if (key == '\r')
			{
				...
				{
					musicOn1 = true;
					PlaySound("Sound\\Rain.wav", NULL, SND_LOOP | SND_ASYNC);  //sound at balcony
				}
			}
		}
...
void iSpecialKeyboard(unsigned char key)
{
	...
	if (flag == 2 && h == 1 && l != 3 && l != 4 && l != 5)
	{
		if (key == GLUT_KEY_INSERT)   //some keyboards may not contain 'END' so instead 'INSERT' can be used
		{
			MS = 1;
			savegame();
...
void change1()
{
	//calling images after images for the conversation
	if (image == 0)
		a++;
...
void change2()
{
	//if select 'no' in the "Want to Investigate?" then go back to the main menu
	if (flag == 1)
	{
		b++;
	}
...
void change3()
{
	if (flag == 2)
	{
		//for the sealed door after the black screen
		f++;
	}
}
void change4()
{
	if (h == 1)
	{
		//for the livingroom after breaking the door
		k++;
	}
}
void change5()
{
	if (l == 1)
	{
		//for the blackscreen with writen BATHROOM on it
		m++;
	}
}
void change6()
{
	if (l == 2)
	{
		//for the blackscreen with writen BEDROOM on it
		n++;
	}
}
void change7()
{
	if (l == 3)
	{
		////for the blackscreen with writen BALCONY on it
		o++;
	}
}
void voot()
